...
test.tiles.create({ tile_name: "tmp_wall", row_max: 6, is_solid: true})
test.tiles.create({ tile_name: "empty", row_max: 6, is_solid: false})
test.tiles.create({ tile_name: "tmp_floor", row_max: 6, is_solid: false})
